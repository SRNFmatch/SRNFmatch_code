...
def enr_match_SRNF(VS, FS, FunS, VT, FT, FunT, weight_coef_dist=1 ,weight_SRNF = 1, weight_MCV = 0, **objfun):
...
def enr_match_SRNF_sym(VS, FS, FunS, VT, FT, FunT, F_sol, Fun_sol, weight_coef_dist_S=1 ,weight_coef_dist_T=1, weight_SRNF = 1, weight_MCV = 0, **objfun):
...
def SRCF(F,V):
    ...
    VectorMeanCurvatureOfVertex[BoundaryIndicatorOfVertex,:] = 0
